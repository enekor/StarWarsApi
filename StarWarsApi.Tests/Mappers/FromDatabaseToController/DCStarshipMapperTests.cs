...
namespace StarWarsApi.Tests.Mappers.FromDatabaseToController
{
    ...
    public class DCStarshipMapperTests
    {
        ...
        {
            // Arrange & Act
            var instance1 = DCStarshipMapper.Instance;
            var instance2 = DCStarshipMapper.Instance;
        ...
        {
            // Arrange
            Starship? nullStarship = null;

            // Act
            var result = _mapper.ToDto(nullStarship);
        ...
        public void ToDto_WithValidInput_ReturnsCorrectMapping()
        {
            ...
            // Act
            var result = _mapper.ToDto(starship);
        ...
        {
            // Arrange
            var emptyList = new List<Starship>();
        ...
        public void ToDtoList_WithValidInput_ReturnsCorrectMapping()
        {
            ...
            // Act
            var result = _mapper.ToDtoList(starships);
